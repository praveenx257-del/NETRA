...
# ----------------- IN-MEMORY BASELINE MODEL TRAINING -----------------
# Generate historical MPLADS training distribution
np.random.seed(42)
baseline_costs = np.random.uniform(500000, 3000000, 200)
baseline_deviations = np.random.uniform(0.9, 1.2, 200)

train_df = pd.DataFrame({
    'sanction_amount': baseline_costs,
    'cost_deviation': baseline_deviations
})
...
historical_titles = [
    "Construction of concrete road in ward 4",
    "Installation of solar street lights in block B",
    "Repair and renovation of community drinking water tank",
    "Construction of primary school boundary wall in village A",
    "Paving of pedestrian pathway near health sub-centre"
]
