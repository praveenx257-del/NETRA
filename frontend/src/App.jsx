...
import { ShieldCheck, Camera, CheckSquare, Layers, Send } from 'lucide-react';

// Replace this with your actual live Render URL!
const API_BASE = 'https://netra-dashboard-olive.vercel.app'; 
...
export default function App() {
  ...
  const handleEvaluate = async (e) => {
    ...
    try {
      ...
      alert(`Failed to connect to backend at ${API_BASE}`);
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <section className="space-y-6">
          ...
          <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm space-y-3">
            <h2 className="text-lg font-bold flex items-center gap-2 text-slate-800">
              <Camera size={18} /> Photo Forensics
            </h2>
